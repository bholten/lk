 ...
 * Weft prints them.
 *
 * Every key row's mask includes LK_MOD_ALT: the keyboard tables bind
 * no Alt chords, so a chord holding Alt always bubbles to the app
 * (alt+arrows, ctrl+alt+anything).  Only the pointer table uses Alt
 * (box select). */
...
static const lk_editor_key_binding ed_key_table[] = {
    EDK(LKK_LEFT, LK_MOD_CTRL, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_MOVE_WORD_LEFT,
        LK_EDK_COMMAND, 1, "move one word left"),
    EDK(LKK_LEFT, 0, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_MOVE_LEFT, LK_EDK_COMMAND,
        1, "move one character left"),
    EDK(LKK_RIGHT, LK_MOD_CTRL, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_MOVE_WORD_RIGHT,
        LK_EDK_COMMAND, 1, "move one word right"),
    EDK(LKK_RIGHT, 0, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_MOVE_RIGHT,
        LK_EDK_COMMAND, 1, "move one character right"),
    EDK(LKK_UP, LK_MOD_CTRL | LK_MOD_SHIFT, LK_EDITOR_MODS_ALL,
        LK_ED_ADD_CURSOR_ABOVE, LK_EDK_COMMAND, 0,
        "add a caret on the visual row above every caret"),
    EDK(LKK_UP, 0, LK_MOD_ALT, LK_ED_MOVE_UP, LK_EDK_COMMAND, 1,
        "move up one visual row"),
    EDK(LKK_DOWN, LK_MOD_CTRL | LK_MOD_SHIFT, LK_EDITOR_MODS_ALL,
        LK_ED_ADD_CURSOR_BELOW, LK_EDK_COMMAND, 0,
        "add a caret on the visual row below every caret"),
    EDK(LKK_DOWN, 0, LK_MOD_ALT, LK_ED_MOVE_DOWN, LK_EDK_COMMAND, 1,
        "move down one visual row"),
    EDK(LKK_HOME, LK_MOD_CTRL, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_MOVE_DOC_START,
        LK_EDK_COMMAND, 1, "move to the start of the document"),
    EDK(LKK_HOME, 0, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_MOVE_ROW_START,
        LK_EDK_COMMAND, 1, "move to the start of the visual row"),
    EDK(LKK_END, LK_MOD_CTRL, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_MOVE_DOC_END,
        LK_EDK_COMMAND, 1, "move to the end of the document"),
    EDK(LKK_END, 0, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_MOVE_ROW_END,
        LK_EDK_COMMAND, 1, "move to the end of the visual row"),
    EDK(LKK_PAGEUP, 0, LK_MOD_ALT, LK_ED_MOVE_PAGE_UP, LK_EDK_COMMAND, 1,
        "move up one page"),
    EDK(LKK_PAGEDOWN, 0, LK_MOD_ALT, LK_ED_MOVE_PAGE_DOWN, LK_EDK_COMMAND, 1,
        "move down one page"),
    EDK(LKK_BACKSPACE, LK_MOD_CTRL, LK_MOD_CTRL | LK_MOD_ALT,
        LK_ED_DELETE_WORD_BACKWARD, LK_EDK_COMMAND, 0,
        "delete the word before the caret"),
    EDK(LKK_BACKSPACE, 0, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_DELETE_BACKWARD,
        LK_EDK_COMMAND, 0,
        "delete the character before the caret (or the selection)"),
    EDK(LKK_DELETE, LK_MOD_CTRL, LK_MOD_CTRL | LK_MOD_ALT,
        LK_ED_DELETE_WORD_FORWARD, LK_EDK_COMMAND, 0,
        "delete the word after the caret"),
    EDK(LKK_DELETE, 0, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_DELETE_FORWARD,
        LK_EDK_COMMAND, 0,
    ...
    EDK(LKK_TAB, 0, LK_MOD_SHIFT | LK_MOD_ALT, LK_ED_INSERT_TEXT,
        LK_EDK_INSERT_TAB, 0,
        "insert tab_size spaces (shift+tab bubbles for focus cycling)"),
    EDK(LKK_A, LK_MOD_CTRL, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_SELECT_ALL,
        LK_EDK_COMMAND, 0, "select the whole document"),
    EDK(LKK_C, LK_MOD_CTRL, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_COPY,
        LK_EDK_COMMAND, 0, "copy the selection(s) to the clipboard"),
    EDK(LKK_X, LK_MOD_CTRL, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_CUT, LK_EDK_COMMAND,
        0, "cut the selection(s) to the clipboard"),
    EDK(LKK_V, LK_MOD_CTRL, LK_MOD_CTRL | LK_MOD_ALT, LK_ED_PASTE,
        LK_EDK_COMMAND, 0, "paste the clipboard at every caret"),
    EDK(LKK_Z, LK_MOD_CTRL | LK_MOD_SHIFT, LK_EDITOR_MODS_ALL, LK_ED_REDO,
        LK_EDK_COMMAND, 0, "redo"),
    EDK(LKK_Z, LK_MOD_CTRL, LK_EDITOR_MODS_ALL, LK_ED_UNDO, LK_EDK_COMMAND, 0,
        "undo"),
    ...
    EDK(LKK_ESCAPE, 0, LK_MOD_ALT, LK_ED_COLLAPSE_CURSORS,
        LK_EDK_COLLAPSE_IF_MULTI, 0,
